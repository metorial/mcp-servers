...
server.registerResource(
  'table-row',
  new ResourceTemplate('supabase://{projectId}/table/{tableName}/row/{rowId}', { list: undefined }),
  {
    title: 'Table Row',
...
server.registerResource(
  'table-schema',
  new ResourceTemplate('supabase://{projectId}/table/{tableName}/schema', { list: undefined }),
  {
    title: 'Table Schema',
...
server.registerResource(
  'storage-bucket',
  new ResourceTemplate('supabase://{projectId}/storage/bucket/{bucketName}', { list: undefined }),
  {
...
server.registerResource(
  'storage-object',
  new ResourceTemplate('supabase://{projectId}/storage/bucket/{bucketName}/object/{objectPath}', { list: undefined }),
  {
...
server.registerTool(
  'upsert_rows',
  {
    ...
    inputSchema: {
      ...
      onConflict: z.string().optional().describe('Columns to check for conflict (comma-separated)')
    }
  },
...
server.registerTool(
  'create_user',
  {
    ...
    inputSchema: {
      ...
      emailConfirm: z.boolean().optional().default(false).describe('Whether email is confirmed'),
...
server.registerTool(
  'create_bucket',
  {
    ...
    inputSchema: {
      ...
      allowedMimeTypes: z.array(z.string()).optional().describe('Array of allowed MIME types')
    }
  },
...
server.registerTool(
  'upload_object',
  {
    ...
    inputSchema: {
      ...
      content: z.string().describe('File content (base64 encoded for binary, plain text otherwise)'),
      contentType: z.string().optional().default('application/octet-stream').describe('MIME type of the file'),
      upsert: z.boolean().optional().default(false).describe('Whether to overwrite existing file')
    }
  },
